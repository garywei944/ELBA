...
def main(ref_filename, reads_filename, depth, read_length_mean, read_length_sd, chimera_fraction):
    ...
    for i in range(num_reads):
        ...
        records = create_read(genome, readlen, bool(random.uniform(0,1) < chimera_fraction))
        if len(records) == 1:
            readseq, startpos, endpos = records[0]
            readname = "{}\tlength={}\tcoords={}[{}..{}]".format(i+1, len(readseq), genome_name, startpos, endpos)
            ...
            readname = "{}\tlength={}\tcoords1={}[{}..{}]\tcoords2={}[{}..{}]\tChimeric".format(i+1, len(readseq), genome_name, startpos1, endpos1, genome_name, startpos2, endpos2)
            reads.append(readseq)
            read_names.append(readname)
